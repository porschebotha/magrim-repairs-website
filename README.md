...
aluminium wheel repair specialist in Windhoek, Namibia.
...
The reviews section shows three example customer cards in `index.html`.
There is no public review submission form — to feature a new customer
review, copy one of the existing `<article class="review-card">` blocks in
`index.html` and edit its name, stars and text.
